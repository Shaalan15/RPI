...
class Grid:
    def __init__(self):
        ...
        self.WindButton = ttk.Button(self.rootFrame, image=self.WindImage, command = self.VoltageReading).grid(column=2, row=1, padx=50)
    ...
    def VoltageOutput(self, read_serial):
        ...
        # while (True):
            ...
            # elif (VoltageValue <= 11.66 and VoltageValue > 11.51):
            elif (read_serial <= 3 and read_serial > 5):
                ...
                # self.LowBatteryImage.image = self.LowBatteryImage
